...
class FormViewAddProduct extends ConsumerWidget {

  const FormViewAddProduct({ super.key });
                ...
                builder: (context, formGroup, _) {
                  return TextButton(
                    ...
                    onPressed: () {
                      ...
                      ref.read(productFormProvider.notifier).onSubmitEdit(productFormMapper);

                      Navigator.pop(context);
                    },
                    child    : const Text('Editar', style: TextStyle( color: Colors.white, fontSize: 24 ),),
                  );
                },
              ),
              // button guardar
