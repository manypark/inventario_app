...
extension ProductQuerySortBy on QueryBuilder<Product, Product, QSortBy> {
  ...
  QueryBuilder<Product, Product, QAfterSortBy> sortByPriceSale() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'priceSale', Sort.asc);
    });
  }

  QueryBuilder<Product, Product, QAfterSortBy> sortByPriceSaleDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'priceSale', Sort.desc);
    });
  }

  QueryBuilder<Product, Product, QAfterSortBy> sortByPriceUnit() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'priceUnit', Sort.asc);
    });
  }

  QueryBuilder<Product, Product, QAfterSortBy> sortByPriceUnitDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ProductQuerySortThenBy
  ...
  QueryBuilder<Product, Product, QAfterSortBy> thenByPriceSale() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'priceSale', Sort.asc);
    });
  }

  QueryBuilder<Product, Product, QAfterSortBy> thenByPriceSaleDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'priceSale', Sort.desc);
    });
  }

  QueryBuilder<Product, Product, QAfterSortBy> thenByPriceUnit() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'priceUnit', Sort.asc);
    });
  }

  QueryBuilder<Product, Product, QAfterSortBy> thenByPriceUnitDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'priceUnit', Sort.desc);
    });
  }
...
extension ProductQueryWhereDistinct
  ...
  QueryBuilder<Product, Product, QDistinct> distinctByPriceSale() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'priceSale');
    });
  }

  QueryBuilder<Product, Product, QDistinct> distinctByPriceUnit() {
    return QueryBuilder.apply(this, (query) {
